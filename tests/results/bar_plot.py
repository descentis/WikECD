...
plt.text(x=1-0.3, y=93.25 - 6, s = '93.25%', size=12)
plt.text(x=2-0.3, y=93.60 - 6, s = '93.60%', size=12)
plt.text(x=3-0.3, y=95.02 - 6, s = '95.02%', size=12)
plt.text(x=4-0.3, y=95.38 - 6, s = '95.38%', size=12)
